        ...
        <div className="w-full fixed">
            ...
            ${isChanged ? '-rotate-90 translate-y-[6px] ' : 'translate-y-0'}`}></div>
              ...
              w-6 h-[3px] bg-[#253F9C] transition duration-300 -translate-y-2`}></div>
                    ...
                    <button className="hidden md:flex md:rounded-3xl xl:rounded-[32px] bg-[#0A66EC] transition duration-500 ease-in-out font-base focus:font-semibold transform focus:scale-100 hover:bg-gradient-to-r hover:from-[#0A66EC] hover:to-[#F46997] md:text-[10px] lg:text-xs xl:text-sm text-white px-6 py-3.5 ">
                        CONTACT US
                    </button>
                </div>
            </div>
