import { linkedin, partnergrid } from '../../assets';
        ...
        return (
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg hover:bottom-0 group">
                <div className="bg-[#ddd] py-14 flex justify-center items-center  relative">
                    ...
                    <p className="absolute h-full px-4 py-4 bg-dark-blue opacity-90 text-white bottom-[-50.75rem] group-hover:bottom-0">
                        {paragraph}
                    </p>
                    <img
        ...
        <section className="pt-14 pb-96">
            ...
            <div className="px-7 pt-24 md:px-16 md:py:12 lg:px-24 xl:px-64 md:pt-40 ">
                <div className="flex flex-col justify-center items-center gap-24 lg:flex-row md:gap-20">
                    ...
                    />
                    <Card
                        url="http://yume_labs.primathontech.co.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FabhinavKumar.16f33dcd.webp&w=384&q=75"
                        name="Abhinav Kr."
                    ...
                    />
                    <Card
                        url="http://yume_labs.primathontech.co.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FpritamSaha.41562fc4.webp&w=256&q=75"
                        name="Pritam Saha"
