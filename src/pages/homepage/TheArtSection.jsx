    ...
    <div className="pb-20">
      <div className="relative flex flex-col mt-10">
        ...
        <div className="absolute top-1/3 w-full lg:ml-32 xl:ml-40 ml-7 md:ml-32">
          ...
          <p
            className="w-1/2 lg:text-5xl text-2xl md:text-5xl xl:text-6xl mt-4 font-poppins"
            ref={textRef}
          >
                ...
                <div className="image-container w-80 lg:w-auto">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="font-roboto text-header-gray">
                      Great Place to Work 2022 Survey: Vincit is the best place
                      to work in Finland, again!
                    </p>
                  </div>
                </div>
              </div>
