    ...
    <>
      <div className="flex flex-col md:flex-row items-stretch justify-center mt-16 gap-2 mx-4 overflow-hidden">
        <div className="bg-light-pink w-full md:w-[508px] mt-16 rounded-xl flex flex-col justify-center items-center service-item-1">
          ...
          <span className="flex lg:mt-6 md:mt-12 items-center justify-center hover:bg-gradient-to-r from-[#F4F8FF] from-30% to-pink-200 bg-[#F4F8FF] mx-6 md:mx-40 py-3 w-56 gap-6 rounded-full service-item-2">
            ...
            <a href={"/service"}>
              <div className="bg-brand-blue rounded-full ml-2 p-3 hover:bg-gradient-to-r from-pink-300 from-30% to-brand-blue">
                <img src="/src/assets/images/right-arrow-icon.png" alt="arrow icon" className="w-4 h-4 hover:scale-125" />
              </div>
            </a>
          </span>
        </div>
        ...
        <div className="mt-8 md:mt-16 w-full md:w-[400px] flex md:flex-col sm:flex-row items-center gap-3 relative service-item-1">
          <div className="w-full lg:h-[320px] md:h-[300px] sm:h-[200px] relative">
            <img src="/src/assets/images/our-service-1.png" alt="service image" className="w-full h-full object-cover rounded-xl" />
          ...
          <div className="w-full h-full md:h-[300px] sm:h-[200px] relative">
            <img src="/src/assets/images/our-service-2.png" alt="service image" className="w-full h-full object-cover rounded-xl" />
            <div className="absolute bottom-0 left-0 p-4">
        ...
        <div className="bg-fade-orange w-full md:w-[400px] mt-8 md:mt-16 rounded-xl flex justify-center items-center overflow-hidden relative service-item-1">
          <div className="overflow-hidden" style={{ marginRight: '-200px' }}>
            <img src="/src/assets/images/our-service-3.png" alt="service image" className="w-full h-full" />
