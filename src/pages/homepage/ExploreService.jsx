...
const ExploreService = () => {
    ...
    useGSAP(() => {
        ...
        gsap.from(container.querySelectorAll('.image-container'), {
            y: 200,
            opacity: 0,
            duration: 1,
            stagger: 0.5,
    ...
    return (
        <div className="px-9 md:px-16 lg:px-20 xl:px-28 2xl:px-36 pt-12 pb-8" ref={containerRef}>
            <div className="flex flex-col md:flex-row gap-2 overflow-hidden">
                <div className="bg-fade-white lg:w-[38%] 2xl:w-[90%] lg:pt-20 pt-10 2xl:pt-40 rounded-xl flex flex-col image-container">
                    ...
                    <span className="flex lg:mt-32 md:mt-16 mt-12 mb-6 items-center justify-center hover:bg-gradient-to-r from-fade-blue-white from-30% to-pink-200 bg-fade-blue-white mx-auto py-2 w-44 lg:w-60 gap-0 lg:gap-8 rounded-full">
                ...
                <div className="w-full flex md:flex-col sm:flex-row items-center gap-3 relative image-container">
                ...
                <div className="bg-fade-orange w-full lg:h-auto md:h-auto h-48 rounded-xl flex justify-center items-center overflow-hidden relative image-container">
