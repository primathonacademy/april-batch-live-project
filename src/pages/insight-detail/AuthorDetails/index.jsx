...
const AuthorDetail = () => {
    ...
    return (
        <>
            <section className="px-[9.5%] py-1 p-7">
                ...
                <div className="flex gap-[20%] flex-wrap gap-y-12 mt-20 md:mb-24 mx-0 flex-col mb-36 ">
                    {data?.map((item) => (
                        <div className="flex max-w-[600px] flex-col gap-7" key={item.id}>
                            <div className="flex md:flex-row gap-7 flex-col">
                                ...
                                <div className="flex flex-col justify-end">
                                    <h4 className="text-[black] text-2xl font-medium font-poppins">
                                        {item.authorName}
                                    </h4>
                ...
                <div className="bg-fade-gray flex-1 h-px opacity-70" />
                <h2 className="text-black text-4xl font-poppins mb-16 max-w-64">Latest Articles</h2>
                                ...
                                <div key={item.id} className="cursor-pointer">
                                    ...
                                    <div className="mt-6 mb-5">
                                        <span className="font-bold text-xl text-[black] font-poppins">
                                            /{item.id < 9 ? `0${item.id}` : item.id} / {item.contentHeading} /{' '}
                                            {item.date}
                                        </span>
