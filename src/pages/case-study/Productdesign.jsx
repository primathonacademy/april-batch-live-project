  ...
  return (
    <section>
                ...
                <div className="bg-accent-blue w-32 md:w-64">
                    <p className="flex justify-center font-serif italic text-white text-lg md:text-xl">
                        Product Design
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row pt-9 md:pt-28 gap-12 xl:gap-36">
                    ...
                    <p className="text-xl opacity-70 ">We’ve crafted a comprehensive solution that seamlessly merges intuitive AI-driven analysis, user-centered product design, and effective project management. Our platform harmonizes these elements to create a unified experience that empowers users at every stage.</p>
                    </div>
                </div>
