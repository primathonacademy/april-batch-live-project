...
const ContactUsBody = () => (
    <section className='md:flex md:flex-row gap-x-[8%] pb-40 flex-col-reverse md:pt-32 pt-20'>
        <div className='basis-2/5'>
            <div className='md:flex md:gap-y-9  md:mb-14 flex-col gap-y-14 mx-0 mb-14'>
                ...
                <div>
                    <h3 className='w-full text-2xl  max-w-[928px] md:text-3xl italic font-light text-[#0b1226] opacity-60  mt-0'>{customerData[0].quote}</h3>
                </div>
            </div>

            <div className='flex md:gap-10  gap-5 p-2.5'>
                <img className='w-28 h-32  md:w-40 md:h-40 absolute -mt-4 mr-2.5 rounded-[50%]' src={gradientImage} alt="gradient image" />
                ...
                <div>
                    ...
                    <span className='text-base mt-3 block max-w-53 md:text-lg text-[gray] md:mt-5'>{customerData[0].designation}</span>
